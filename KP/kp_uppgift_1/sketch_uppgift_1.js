...
function draw() {
  ...
  */
  ...
  // Lite info-text
  textSize(13);
  text("Flytta den rörande cirkeln in i SH-loggans lilla cirkel och klicka", 60, 100);
  ...
  Stroke funktionen ritar upp linjerna inom det valda området. 
  Loop-funktionen skapar en kontinuerlig rotation av linjerna och cirkeln. 
  Noise funktionen har ett givet nummer på de givande kordinaterna. 
  Framecount håller de nummer av frames som visas sedan programmet startade. 
  Ändringar justerar hastigheten på det rörande objektet. 
  ...
  */
  ...
  for (let i = 2; i < 400; i = i+20) {
        rotate(
            noise(frameCount * 0.001) * (1000/mouseX)
        );
