...
//myrow-variablen skriver sedan ut de poster som hämtats från databasen med information.
   ...
   echo "<tr><td>" . $myRow['fornamn'] . "</td><td>" . $myRow['efternamn'] . "</td><td>" . $myRow['fodelsear'] . '<td><a href="update_artist.php?artist_id=' . $myRow['artist_id'] . '">Ändra</a></td>' . '<td><a href="delete_artist.php?artist_id=' . $myRow['artist_id'] . '">Radera</a></td>' . "\n";"</td></tr>\n\n";
