...
<?php
	...
	if(isset($_POST['spara'])){
		...
		$Gatuadress = $_POST['fodelsear'];

		// Skapa SQL-fråga (INSERT), använd variablerna som fyllts med det som användaren
		// skrivit in i formuläret.
		$sql = "INSERT INTO person (fnamn,enamn,gatuadress,postnummer,postadress,telefon,epost) VALUES ('$Fornamn','$Efternamn','$Fodelsear')";
		...
		echo "<a href='indv.php'>Tillbaka till listningssidan</a>";
	}
	...
	// Om användare INTE klickat på spara-knapp
		...
		<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
			<table>
				...
				<tr><td class="yell">Förnamn</td><td><input type="text" name="Fornamn"  /></td></tr>
				<tr><td class="yell">Efternamn</td><td><input type="text" name="Efternamn"  /></td></tr>
				<tr><td class="yell">Födelseår</td><td><input type="text" name="Fodelsear"  /></td></tr>
